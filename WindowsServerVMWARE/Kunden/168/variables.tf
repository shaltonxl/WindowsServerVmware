...
# Eingabe des Wiederherstellungspasswortes mit Überprüfung
...
# Eingabe des Service_Ansible Passwortes mit Überprüfung
...
# Eingabe des Service_Terraform Passwortes mit Überprüfung
...
variable "netmask" {
    description = "Geben Sie den Präfix Ihres Netzwerkes ein: "
    type = string
    default = 24
}
